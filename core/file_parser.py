...
def extract_text(file: UploadFile):
    ...
    # === DOCX ===
        ...
        # (Blok OCR Tesseract untuk gambar di dalam DOCX sudah dihapus)
...
# ==========================
# 🔹 EKSTRAK GAMBAR DARI FILE (Biarkan jika sewaktu-waktu butuh gambarnya)
# ==========================
...
# (Fungsi extract_images_with_ocr sudah dihapus sepenuhnya)
